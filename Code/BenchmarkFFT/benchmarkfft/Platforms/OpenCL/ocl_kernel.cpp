...
void cpxAddSubMulGlobal(__global cpx* inL, __global cpx* inU, __global cpx *outL, __global cpx *outU, cpx *W)
{
    float x = inL->x - inU->x;
    float y = inL->y - inU->y;
    outL->x = inL->x + inU->x;
...
<<<<<<< HEAD:Code/BenchmarkFFT/benchmarkfft/Platforms/OpenCL/ocl_kernel.cl
...
>>>>>>> origin/master:Code/BenchmarkFFT/benchmarkfft/Platforms/OpenCL/ocl_kernel.cpp
