...
static __inline void _fft_tbbody_f(cpx *in, cpx *out, cpx *W, const int bit, const int steps, const int dist, const int dist2, const int n2)
{
...
static __inline void _fft_tbbody_f(cpx *in, cpx *out, const float ang, const int bit, const int steps, const int dist, const int dist2, const int n2)
{
    const unsigned int pmask = (dist - 1) << steps;
    const unsigned int lmask = 0xFFFFFFFF << bit;
    int l, u, p, o;
