...
__global__ void _tsConstantGeometry_Body(cpx *in, cpx *out, cpx *W, unsigned int mask, int n2);
...
__host__ void tsConstantGeometry(const fftDir dir, cpx **dev_in, cpx **dev_out, cpx *dev_W, int n)
{
