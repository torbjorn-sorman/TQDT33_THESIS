...
\begin{figure}
	...
	\subfloat[OpenCL setup\label{setup:ocl}]{		
		\includestandalone[width={\setupWidth}]{code/setup/ocl}		
	}
	\hfill
	\subfloat[OpenCL setup\label{setup:dx}]{		
		\includestandalone[width={\setupWidth}]{code/setup/dx}		
	}
	\newline
	\subfloat[OpenCL setup\label{setup:gl}]{		
		\includestandalone[width={\setupWidth}]{code/setup/gl}		
	}
	\caption{}		
