...
Figure \ref{lst:sample:global:omp} shows how the section within an iterator construction is parallelized by scheduling the workload evenly with the \code{static} keyword. Each thread will work on a consecutive span of the iterator variable. 
